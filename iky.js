...
case 'sendbug':
        ...
        case 'creator':
               ...
               case 'spamcall':{
                ...
                fetchJson(`https://api.zeks.me/api/spamcall?apikey=${zekskey}&no=${args[1]}`)
                .then((data) => {
            ...
            case 'spamsms':{
                ...
                try {
                    ...
                    await fetchJson(`https://api.lolhuman.xyz/api/sms/spam8?apikey=79c4683acff3cb4fbddbc08a&nomor=${args[1]}`)
                    reply("Success")
               } catch (err) {
                            sendMess(ownerNumber, `${command} Error:` + err)
                            reply(mess.error.api)
...
`
        ...
        case 'simi':
					...
					teks = body.slice(5)
					anu = await simih(teks) //fetchJson(`https://api.lolhuman.xyz/api/simi?apikey=79c4683acff3cb4fbddbc08a&text=${teks}`, {method: 'get'})
				...
				buff = await getBuffer(`http://api.lolhuman.xyz/api/meme/darkjoke?apikey=79c4683acff3cb4fbddbc08a`, {method: 'get'})
...
case 'chiisaihentai':
                ...
                reply (mess.wait)
              buff = await getBuffer(`https://api.lolhuman.xyz/api/random/nsfw/${command}?apikey=79c4683acff3cb4fbddbc08a`)
              ...
              ikyy.relayWAMessage(prep)
                ...
                case 'nsfw_avatar':
                reply (mess.wait)
               buff = await getBuffer(`https://api.lolhuman.xyz/api/random2/${command}?apikey=79c4683acff3cb4fbddbc08a`)
                buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `➡️Next`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'crated by LeonzGanz', imageMessage: imageMsg,
              contentText:`Follow @leonvx._`,buttons,headerType:4}
...
break
                ...
                reply (mess.wait)
                    ...
                    ini_txt = args.join(" ")
                  buff = await getBuffer(`https://api.lolhuman.xyz/api/textprome/${command}?apikey=79c4683acff3cb4fbddbc08a&text=${ini_txt}`)
              ...
              ikyy.relayWAMessage(prep)
                ...
                reply (mess.wait)
                    ...
                    txt1 = args[0]
                    txt2 = args[1]
                 buff = await getBuffer(`https://api.lolhuman.xyz/api/textprome2/${command}?apikey=79c4683acff3cb4fbddbc08a&text1=${txt1}&text2=${txt2}`)
                          buttons = [{buttonId: `!menu`,buttonText:{displayText: `BACK MENU`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'crated by leonz', imageMessage: imageMsg,
              contentText:`Follow @leonvx._`,buttons,headerType:4}
              ...
              ikyy.relayWAMessage(prep)
                ...
                reply (mess.wait)
                    if (args.length == 0) return reply(`Example: ${prefix + command} LoL Human`)
                    ini_txt = args.join(" ")
                  buff = await getBuffer(`https://api.lolhuman.xyz/api/photooxy1/${command}?apikey=79c4683acff3cb4fbddbc08a&text=${ini_txt}`)
                          buttons = [{buttonId: `!menu`,buttonText:{displayText: `BACK MENU`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'crated by leonz', imageMessage: imageMsg,
              contentText:`Follow @leonvx._`,buttons,headerType:4}
              ...
              ikyy.relayWAMessage(prep)
                ...
                reply (mess.wait)
                    ...
                    txt1 = args[0]
                    txt2 = args[1]
                buff = await getBuffer(`https://api.lolhuman.xyz/api/photooxy2/${command}?apikey=79c4683acff3cb4fbddbc08a&text1=${txt1}&text2=${txt2}`)
                          buttons = [{buttonId: `!menu`,buttonText:{displayText: `BACK MENU`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'crated by leonz', imageMessage: imageMsg,
              contentText:`Follow @leonvx._`,buttons,headerType:4}
              ...
              ikyy.relayWAMessage(prep)
                ...
                reply (mess.wait)
                    if (args.length == 0) return reply(`Example: ${prefix + command} LoL Human`)
                    ini_txt = args.join(" ")
             buff = await getBuffer(`https://api.lolhuman.xyz/api/ephoto1/${command}?apikey=79c4683acff3cb4fbddbc08a&text=${ini_txt}`)
               buttons = [{buttonId: `!menu`,buttonText:{displayText: `BACK MENU`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'crated by leonz', imageMessage: imageMsg,
              contentText:`Follow @leonvx._`,buttons,headerType:4}
...
case "mode":
        ...
        break;
	      case 'self':
              ...
              break
                case 'quotes':
                    quotes = await fetchJson(`https://api.lolhuman.xyz/api/random/quotes?apikey=79c4683acff3cb4fbddbc08a`)
                    ...
                    break
                case 'quotesanime':
                    quotes = await fetchJson(`https://api.lolhuman.xyz/api/random/quotesnime?apikey=79c4683acff3cb4fbddbc08a`)
                    quotes = quotes.result
                    quote = quotes.quote
                ...
                case 'quotesdilan':
                   ...
                   break
                    break
                case 'quotesimage':
                    buff = await getBuffer(`https://api.lolhuman.xyz/api/random/${command}?apikey=79c4683acff3cb4fbddbc08a`)
                    buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `➡️Next`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'crated by leonz', imageMessage: imageMsg,
              ...
              ikyy.relayWAMessage(prep)
                ...
                case 'pantun':
                case 'bucin':
                    get_result = await fetchJson(`https://api.lolhuman.xyz/api/random/${command}?apikey=79c4683acff3cb4fbddbc08a`)
        ...
        break;
                    break
                case 'randomnama':
                    anu = await fetchJson(`https://api.lolhuman.xyz/api/random/nama?apikey=79c4683acff3cb4fbddbc08a`)
                    kyyi = anu.result
       ...
       // Movie & Story
                case 'lk21':
                    ...
                    query = args.join(" ")
                    get_result = await fetchJson(`https://api.lolhuman.xyz/api/lk21?apikey=79c4683acff3cb4fbddbc08a&query=${query}`)
                    ...
                    break
                case 'drakorongoing':
                    get_result = await fetchJson(`https://api.lolhuman.xyz/api/drakorongoing?apikey=79c4683acff3cb4fbddbc08a`)
                    get_result = get_result.result
                ...
                case 'wattpad':
                    ...
                    ini_url = args[0]
                    get_result = await fetchJson(`https://api.lolhuman.xyz/api/wattpad?apikey=79c4683acff3cb4fbddbc08a&url=${ini_url}`)
                    get_result = get_result.result
                    ini_txt = `Title : ${get_result.title}\n`
                    ini_txt += `Rating : ${get_result.rating}\n`
                ...
                case 'wattpadsearch':
                    ...
                    break
                case 'cerpen':
                    get_result = await fetchJson(`https://api.lolhuman.xyz/api/cerpen?apikey=79c4683acff3cb4fbddbc08a`)
                    get_result = get_result.result
                    ini_txt = `Title : ${get_result.title}\n`
        ...
        break;
                    break
                case 'ceritahoror':
                    get_result = await fetchJson(`https://api.lolhuman.xyz/api/ceritahoror?apikey=79c4683acff3cb4fbddbc08a`)
                    get_result = get_result.result
                    ini_txt = `Title : ${get_result.title}\n`
                    ini_txt += `Desc : ${get_result.desc}\n`
                    ini_txt += `Story :\n${get_result.story}\n`
...
// Islami //
                ...
                case 'alquranaudio':
                    ...
                    surah = args[0]
                    ini_buffer = await getBuffer(`https://api.lolhuman.xyz/api/quran/audio/${surah}?apikey=79c4683acff3cb4fbddbc08a`)
...
Ket : Ketik /resetgame , Untuk Mereset Permainan Yg Ada Di Grup!`, text, {contextInfo: {mentionedJid: [player2]}})
     ...
     case 't':
       ...
       case 'tebakanime':
              ...
              get_result = await fetchJson(`https://api.lolhuman.xyz/api/tebakchara?apikey=79c4683acff3cb4fbddbc08a`)
              get_result = get_result.result
       ...
       case 'siapaaku':
              ...
              get_result = await fetchJson(`https://api.lolhuman.xyz/api/tebak/siapaaku?apikey=79c4683acff3cb4fbddbc08a`)
              get_result = get_result.result
       ...
       case 'tebakkata':
              ...
              get_result = await fetchJson(`https://api.lolhuman.xyz/api/tebak/kata?apikey=79c4683acff3cb4fbddbc08a`)
              get_result = get_result.result
              jawaban = get_result.jawaban
       ...
       case 'tebaklirik':
              ...
              get_result = await fetchJson(`https://api.lolhuman.xyz/api/tebak/lirik?apikey=79c4683acff3cb4fbddbc08a`)
              get_result = get_result.result
              jawaban = get_result.answer
              kisi_kisi = jawaban.replace(/[b|c|d|f|g|h|j|k|l|m|n|p|q|r|s|t|v|w|x|y|z]/gi, '_')
              pertanyaan = get_result.question
      ...
      case 'tebakjenaka':
              ...
              get_result = await fetchJson(`https://api.lolhuman.xyz/api/tebak/jenaka?apikey=79c4683acff3cb4fbddbc08a`)
              get_result = get_result.result
              jawaban = get_result.answer
              kisi_kisi = jawaban.replace(/[b|c|d|f|g|h|j|k|l|m|n|p|q|r|s|t|v|w|x|y|z]/gi, '_')
              pertanyaan = get_result.question
       ...
       case 'kimiakuis':
              ...
              get_result = await fetchJson(`https://api.lolhuman.xyz/api/tebak/unsurkimia?apikey=79c4683acff3cb4fbddbc08a`)
              get_result = get_result.result
       ...
       case 'tebakbendera':
              ...
              get_result = await fetchJson(`https://api.lolhuman.xyz/api/tebak/bendera?apikey=79c4683acff3cb4fbddbc08a`)
              get_result = get_result.result
              jawaban = get_result.name
              kisi_kisi = jawaban.replace(/[b|c|d|f|g|h|j|k|l|m|n|p|q|r|s|t|v|w|x|y|z]/gi, '_')
       ...
       case 'susunkata':
              ...
              get_result = await fetchJson(`https://api.lolhuman.xyz/api/tebak/susunkata?apikey=79c4683acff3cb4fbddbc08a`)
              get_result = get_result.result
              jawaban = get_result.jawaban
              pertanyaan = get_result.pertanyaan
       ...
       case 'asahotak':
              ...
              get_result = await fetchJson(`https://api.lolhuman.xyz/api/tebak/asahotak?apikey=79c4683acff3cb4fbddbc08a`)
              get_result = get_result.result
              jawaban = get_result.jawaban
              kisi_kisi = jawaban.replace(/[b|c|d|f|g|h|j|k|l|m|n|p|q|r|s|t|v|w|x|y|z]/gi, '_')
              pertanyaan = get_result.pertanyaan
       ...
       case 'caklontong':
              ...
              get_result = await fetchJson(`https://api.lolhumsn.xyz/api/tebak/caklontong2?apikey=79c4683acff3cb4fbddbc08a`)
              get_result = get_result.result
              jawaban = get_result.answer
              kisi_kisi = jawaban.replace(/[b|c|d|f|g|h|j|k|l|m|n|p|q|r|s|t|v|w|x|y|z]/gi, '_')
              pertanyaan = get_result.question
...
//------------------< Downloader/Search/Anime >-------------------
       ...
       case 'soundcloud':
              ...
              reply(mess.wait)
              anu = await fetchJson(`https://api.lolhuman.xyz/api/soundcloud?apikey=79c4683acff3cb4fbddbc08a&url=${q}`)
...
ikyy.sendMessage(from,{url:'./'+kyyyy},audio,{mimetype:'audio/mpeg'})
       ...
       case 'tiktoknowm':
              ...
              data = await fetchJson(`https://api.lolhuman.xyz/api/tiktok?apikey=79c4683acff3cb4fbddbc08a&url=${q}`)
  ...
  case 'xnxxsearch':
      ...
      case 'tiktokaudio':
             ...
             ini_link = args[0]
             get_audio = await getBuffer(`https://api.lolhuman.xyz/api/tiktokmusic?apikey=79c4683acff3cb4fbddbc08a&url=${ini_link}`)
             ikyy.sendMessage(from, get_audio, audio, { mimetype: Mimetype.mp4Audio, quoted: freply })
             break
      case 'fbdl':
      case 'fb':
      case 'facebok':
					anu = await fetchJson(`ttps://api.lolhuman.xyz/api/facebook?apikey=79c4683acff3cb4fbddbc08a&url==${q}`)
      ...
      case 'ssweb':
             ...
             reply(mess.wait)
             ini_link = args[0]
             ini_buffer = await getBuffer(`https://api.lolhuman.xyz/api/ssweb?apikey=79c4683acff3cb4fbddbc08a&url=${ini_link}`)
       ...
       case 'nhentaipdf':
             ...
             try {
             henid = args[0]
             get_result = await fetchJson(`https://api.lolhuman.xyz/api/nhentai/${henid}?apikey=79c4683acff3cb4fbddbc08a`)
             get_result = get_result.result
...
🐤 Character : ${get_info.characters.join(", ")}\n`
             ...
             reply(mess.wait)
             anu = await fetchJson(`https://api.lolhuman.xyz/api/nhentaipdf/${henid}?apikey=79c4683acff3cb4fbddbc08a`)
       ...
       case 'manga':
              ...
              reply(mess.wait)
              query = args.join(" ")
              get_result = await fetchJson(`https://api.lolhuman.xyz/api/manga?apikey=79c4683acff3cb4fbddbc08a&query=${query}`)
              get_result = get_result.result
       ...
       case 'doujindesu':
             ...
             reply(mess.wait)
             try {
             doujinnya = await got.get(`https://api.lolhuman.xyz/api/doujindesusearch?apikey=79c4683acff3cb4fbddbc08a&query=${q}`).json()
      ...
      case 'anime':
             ...
             reply(mess.wait)
             query = args.join(" ")
             get_result = await fetchJson(`https://api.lolhuman.xyz/api/anime?apikey=79c4683acff3cb4fbddbc08a&query=${query}`)
             get_result = get_result.result
             ini_txt = `Id : ${get_result.id}\n`
             ini_txt += `Id MAL : ${get_result.idMal}\n`
             ini_txt += `Title : ${get_result.title.romaji}\n`
      ...
      case 'kusonime':
             ...
             reply(mess.wait)
             query = args.join(" ")
             get_result = await fetchJson(`https://api.lolhuman.xyz/api/kusonimesearch?apikey=79c4683acff3cb4fbddbc08a&query=${query}`)
             get_result = get_result.result
             ini_txt = `Title : ${get_result.title}\n`
       ...
       case 'otakudesu':
              ...
              reply(mess.wait)
              query = args.join(" ")
              get_result = await fetchJson(`https://api.lolhuman.xyz/api/otakudesusearch?apikey=79c4683acff3cb4fbddbc08a&query=${query}`)
              get_result = get_result.result
              ini_txt = `Title : ${get_result.title}\n`
              ini_txt += `Japanese : ${get_result.japanese}\n`
       ...
       case 'nekopoi':
              ...
              ini_url = args[0]
              get_result = await fetchJson(`https://api.lolhuman.xyz/api/nekopoi?apikey=79c4683acff3cb4fbddbc08a&url=${ini_url}`)
              get_result = get_result.result
       ...
       case 'nekopoisearch':
              ...
              query = args.join(" ")
              get_result = await fetchJson(`https://api.lolhuman.xyz/api/nekopoisearch?apikey=79c4683acff3cb4fbddbc08a&query=${query}`)
              get_result = get_result.result
              ini_txt = ""
              for (var x of get_result) {
              ini_txt += `\`\`\`🐥 Title : ${x.title}\`\`\`\n`
       ...
       case 'nakanomiku':
              reply(mess.wait)
              res = await axios.get(`https://api.lolhuman.xyz/api/pinterest2?apikey=79c4683acff3cb4fbddbc08a&query=${command}`)
       ...
       case 'storyanime':
              ...
              reply(mess.wait)
              anu = await fetchJson(`https://api.lolhuman.xyz/api/storynime?apikey=79c4683acff3cb4fbddbc08a`)
...
break
         ...
         case 'pinterest':
		   if (args.length == 0) return reply(`Example: ${prefix + command} loli`)
                    query = args.join(" ")
                 reply (mess.wait)
                    ini_url = await fetchJson(`http://api.lolhuman.xyz/api/pinterest?apikey=79c4683acff3cb4fbddbc08a&query=${query}`)
       ...
       case 'img2url':
         ...
         case 'asupan': // shansekai                
              ...
              .then(async (body) => {
               ...
               sendMediaURL(from, `https://api.lolhuman.xyz/api/asupan?apikey=79c4683acff3cb4fbddbc08a`, 'Follow IG: https://www.instagram.com/leonvx._ untuk mendapatkan asupan lebih banyak.')
...
//------------------< Level >-------------------
      case 'level': 
              ...
              buffer = await getBuffer(`https://api.lolhuman.xyz/api/rank?apikey=79c4683acff3cb4fbddbc08a&img=${profilePic}&background=https://telegra.ph/file/443b6600636aed1d94acd.jpg&username=${encodeURI(pushname)}&level=${userLevel}&ranking=${Number(userRank)}&currxp=${userXp}&xpneed=${requiredXp}`)
...
`
      ...
      case 'tiktokstalk':
             ...
             reply(mess.wait)
             stalk_toktok = args[0]
             get_result = await fetchJson(`http://api.lolhuman.xyz/api/stalktiktok/${stalk_toktok}?apikey=79c4683acff3cb4fbddbc08a`)
             get_result = get_result.result
...
woy = args.join(" ")
reply('wait....')
anjay = `https://api.lolhuman.xyz/api/ttp2?apikey=79c4683acff3cb4fbddbc08a&text=${woy}&color=white`
