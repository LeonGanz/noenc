...
`
        ...
        case 'simi':
				...
				buff = await getBuffer(`http://lolhuman.herokuapp.com/api/meme/darkjoke?apikey=79c4683acff3cb4fbddbc08a`, {method: 'get'})
...
Ket : Ketik /resetgame , Untuk Mereset Permainan Yg Ada Di Grup!`, text, {contextInfo: {mentionedJid: [player2]}})
     ...
     case 't':
       ...
       case 'tebakanime':
              ...
              get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/tebakchara?apikey=79c4683acff3cb4fbddbc08a`)
              get_result = get_result.result
...
//------------------< Level >-------------------
      case 'level': 
              ...
              buffer = await getBuffer(`https://lolhuman.herokuapp.com/api/rank?apikey=79c4683acff3cb4fbddbc08a&img=${profilePic}&background=https://telegra.ph/file/443b6600636aed1d94acd.jpg&username=${encodeURI(pushname)}&level=${userLevel}&ranking=${Number(userRank)}&currxp=${userXp}&xpneed=${requiredXp}`)
